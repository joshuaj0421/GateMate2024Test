...
export interface IWeatherData {
  ...
  day2: { weather: IDailyWeather; };
  day3: { weather: IDailyWeather; };
  day4: { weather: IDailyWeather; };
  day5: { weather: IDailyWeather; };
  day6: { weather: IDailyWeather; };
  day7: { weather: IDailyWeather; };
}
