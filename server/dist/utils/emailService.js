...
exports.sendCriticalGateAlert = void 0;
const nodemailer = require("nodemailer");
class RateLimiter {
    constructor() {
        this.emailLog = new Map();
        this.COOLDOWN_PERIOD = 1800000;
    }
    canSendEmail(key) {
...
const sendCriticalGateAlert = async (userEmail, gateId, status, actualWaterLevel, idealWaterLevel) => {
...
exports.sendCriticalGateAlert = sendCriticalGateAlert;
